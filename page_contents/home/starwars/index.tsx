...
// import falconSfx from '../../../sounds/falcon.mp3'
...
export const HomeStarwarsSection = () => {
  ...
  return <div className='py-32 justify-center'>
    <div
    ...
    >
      <motion.p
        ...
        animate={ falconFlag ? {} : { rotate: [0, 0, 0, 0, 0, 0, 0, 0, 0, -7, 7, 0, 7, -7, 0] }}
