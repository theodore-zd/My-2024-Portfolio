export default [
  {
    ...
    info: [
      'Work with clients to design and develop websites to increase sales and customer retention. By optimizing UI/UX, SEO, and accessibility, we consistently achieved 95+ lighthouse scores.',
      'With an in-house built CMS, we manage client content and facilitate additional functionality such as blogging systems, analytics, and editable api-first content structures. The CMS is built using NodeJs, TypeScript and Docker allowing for a microservice architecture that facilitates api-first content systems operating headlessly.',
  ...
  },
  {
    ...
    desc: 'Issued by McMaster Design League · Oct 2019',
    info: [
