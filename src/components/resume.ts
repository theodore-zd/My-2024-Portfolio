export const resume = {
  professionalSummary: `
    Full-Stack Developer with 7+ years of experience building high-performance, data-driven solutions for scientific and computational fields. Skilled in optimizing backend systems, designing seamless user interfaces, and delivering scalable applications that elevate functionality and speed.
