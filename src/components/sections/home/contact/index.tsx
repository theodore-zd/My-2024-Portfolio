...
const HomeContactSection = () => {
  return <section
    className='relative w-full max-w-[1000px] px-4 md:px-10 py-20 mx-auto text-center '
  >
      <h5 className='font-extrabold py-20 pt-36 text-theme-text-main text-6xl headerFont'>Let’s make something <br/> awesome! 👍</h5>
      <a
        className='font-extrabold py-20 pt-36 text-theme-accent text-3xl underline headerFont'
        target='_blank'
