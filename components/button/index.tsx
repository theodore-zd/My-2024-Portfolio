...
export const Button = (props:{children:any, center?:any, onClick:Function, outline?:any, grey?:boolean, className?:any}) => {
  ...
  return <button
    ...
    className={
      ...
      'hover:scale-x-[1.02] hover:scale-y-[0.98]  ' + className
    }
   />
}
