    ...
    <div className='relative h-[60px] flex mt-[10px] headerFont text-theme-text-main'>
      <Link href="/">
        ...
        >
          ...
          <p
            className={'font-bold text-lg mt-5 ml-4 ' + (menuOpen ? 'text-theme-text-main ' : 'opacity-80 ')}
          >Theodore</p>
        </a>
    ...
    >
      <div
        className={
          ...
          (hover ? 'w-6 ml-1 mr-1 bg-theme-accent ' : menuOpen ? 'w-8 bg-theme-text-main ' : 'w-8 bg-theme-text-main ') +
      ...
      <div
        className={
          'h-[3px] mt-2 transition-all transform  shadow-lg ' +
          (hover ? 'w-4 ml-2 mr-2 bg-theme-accent ' : menuOpen ? 'w-8 bg-theme-text-main ' : 'w-8 bg-theme-text-main ') +
